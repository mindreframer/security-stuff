...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <title>Go Talks - Kyle Isom</title>
...
<div id="menu">
<a href="http://kyleisom.net/">Home</a>
<a href="http://www.kyleisom.net/categories/golang/">Blog</a>
<a href="https://github.com/gokyle/">Github</a>
</div>
<div id="heading"><a href="/">github.com/gokyle/gokyle.talks</a></div>
</form>
...
and code is licensed under a <a href="/LICENSE">ISC license</a>.<br>
</div>
<script type="text/javascript">
  ...
  (function() {
    ...
    t.async = true;
    t.id    = 'gauges-tracker';
    t.setAttribute('data-site-id', '5141e3a2613f5d1f08000010');
